...
from .attachments import analyze_pdf_attachments, gateway_pdf_attachments
...
def main(argv: list[str] | None = None) -> int:
    ...
    analyze_many = commands.add_parser("analyze-pdfs")
    analyze_many.add_argument("pdfs", nargs="+", help="Bounded local text PDFs")
    analyze_many.add_argument("--tenant", required=True, help="University tenant, for example uni:tum")
    analyze_many.add_argument("--module", required=True, dest="module_id")
    analyze_many.add_argument("--exam", required=True, dest="exam_id")
    analyze_many.add_argument("--exam-date", required=True)
    analyze_many.add_argument("--question", required=True)
    ...
    try:
        ...
        elif args.command == "analyze-pdfs":
            attachments = gateway_pdf_attachments(args.pdfs)
